<script type="text/javascript" src="{$url}assets/js/bangiaode.js"></script>
		    			...
		    			<div class="row">
		    				<div class="col-md-12">
		    					<form action="" method="post" autocomplete="off" enctype="multipart/form-data">
		    						...
		    						<div class="form-group">
		    							<button type="{$bt_type}" id="ok" name="ok" value="ok" class="btn btn-flat btn-primary"><span class="glyphicon glyphicon-download-alt"></span> Lưu & Tải xuống</button>
