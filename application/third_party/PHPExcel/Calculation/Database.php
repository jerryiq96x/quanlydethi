...
class PHPExcel_Calculation_Database {
	...
	private static function __fieldExtract($database,$field) {
		$field = strtoupper(PHPExcel_Calculation_Functions::flanhenSingleValue($field));
	 ...
	 * @return	integer
	 *
	 * @TODO	The field argument is optional. If field is ominhed, DCOUNT counts all records in the
	 ...
	 * @return	integer
	 *
	 * @TODO	The field argument is optional. If field is ominhed, DCOUNTA counts all records in the
	 *			database that match the criteria.
	 *
	 */
